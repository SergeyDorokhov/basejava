...
public class ResumeData {
    ...
    private final Experience javaOnlineProjects = new Experience("Java Online Projects", "http://javaops.ru/",
            new Experience.Position(DateUtil.of(2013, Month.OCTOBER), LocalDate.now(), "Автор проекта",
                    "Создание, организация и проведение Java онлайн проектов и стажировок."));
    private final Experience university = new Experience("Санкт-Петербургский национальный исследовательский университет " +
            "информационных технологий, механики и оптики", "www.ifmo.ru", new Experience.Position(DateUtil.of(1993, Month.SEPTEMBER),
    ...
    private final Experience experienceWithNull = new Experience("МГУ", "https://www.msu.ru/", new Experience.Position(DateUtil.of(2000, Month.JANUARY),
